    ...
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-6 flex justify-between">
            ...
            <form action="" method="post">
                ...
                <!-- <button type="submit" name="cari" id="tombol-cari" class="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-700 transition duration-200">Cari</button> -->
            </form>
